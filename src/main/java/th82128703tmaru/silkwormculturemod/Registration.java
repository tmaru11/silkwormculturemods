...
public class Registration {private static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, "silkwormculturemod");
    ...
    public static final RegistryObject<Item> TESTBLOCK_ITEM = fromBlock(TESTBLOCK);
    ...
    public static final RegistryObject<Item> TESTBLOCK2_ITEM = fromBlock(TESTBLOCK2);
